...
export function ComparisonCard({ ad }: AdProps) {
  return (
    <div className="flex flex-col md:flex-row w-full h-[600px] bg-paper shadow-overlay rounded-2xl overflow-hidden font-body border border-ink/10 bg-noise">
      {/* Ad Half */}
      ...
      <div className="flex-1 p-10 bg-[#E8E2D2] flex flex-col justify-center items-center text-center relative shadow-inner">
        ...
        <div className="font-mono text-ink text-lg leading-relaxed mb-8 max-w-md">
          {ad.honestCopy}
        </div>
